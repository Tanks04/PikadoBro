...
**Trenutna testna verzija: v0.40 TEST**
...
v0.40 prilagođava aktivnu igru stvarnoj visini i širini ekrana. Na mobitelima su quick-score tipke složene kompaktnije, a keypad i UNDO ostaju unutar vidljivog prozora kako bi se smanjilo slučajno scrollanje tijekom bacanja.

### v0.40 provjereni bugfixevi

Uz responsive gameplay iz v0.31, v0.40 ispravlja Master Out bust na preostalih 1, Resume oznake za Speed Game i Checkout Challenge, zaustavljanje timera pri povratku na Početnu, oznaku verzije u JSON backupu, HR/EN naziv backup datoteke, povrat aktivne igre nakon restorea i zatvaranje AudioContexta nakon Crazy beepa.

### Landscape / Redmi Pad SE 8.7

v0.40 ima poseban compact landscape raspored. Numerička tipkovnica i svi quick-score gumbi moraju ostati unutar vidljivog ekrana, a UNDO više ne smije prekrivati tipke. Posebno je provjeren layout za uređaje klase 1340×800 / 5:3 poput Redmi Pad SE 8.7.
